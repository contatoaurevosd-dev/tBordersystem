...
      // Device info
      cmd.BOLD_ON,
      this.textToBytes('EQUIPAMENTO'),
      cmd.BOLD_OFF,
      cmd.LINE_FEED,
      this.textToBytes(line),
      cmd.LINE_FEED,
      this.textToBytes(`Marca: ${order.brand} - Modelo: ${order.model}`),
      cmd.LINE_FEED,
      this.textToBytes(`Cor: ${order.deviceColor}`),
      cmd.LINE_FEED,
      this.textToBytes(`Condicao Fisica: ${order.physicalCondition}`),
      cmd.LINE_FEED,
      this.textToBytes(`Acessorios: ${order.accessories}`),
      cmd.LINE_FEED,
      cmd.LINE_FEED,
      // Password Info
      cmd.BOLD_ON,
      this.textToBytes('SENHA/PADRAO'),
      cmd.BOLD_OFF,
      cmd.LINE_FEED,
      this.textToBytes(line),
      cmd.LINE_FEED,
      this.textToBytes(`Tipo: ${order.passwordType}`),
      cmd.LINE_FEED,
      order.passwordValue ? this.combineBytes(this.textToBytes('Valor: ' + order.passwordValue), cmd.LINE_FEED) : new Uint8Array(),
      cmd.LINE_FEED,
      // Problem Description
      cmd.BOLD_ON,
      this.textToBytes('DEFEITO/PROBLEMA'),
      cmd.BOLD_OFF,
      cmd.LINE_FEED,
      this.textToBytes(line),
      cmd.LINE_FEED,
      this.textToBytes(order.problemDescription),
      cmd.LINE_FEED,
      cmd.LINE_FEED,
      // Values
      cmd.BOLD_ON,
      this.textToBytes('VALORES'),
      cmd.BOLD_OFF,
      cmd.LINE_FEED,
      this.textToBytes(doubleLine),
      cmd.LINE_FEED,
      this.textToBytes(`Servico Total: ${formatCurrency(order.serviceValue)}`),
      cmd.LINE_FEED,
      this.textToBytes(`Entrada/Sinal: ${formatCurrency(order.entryValue)}`),
      cmd.LINE_FEED,
      this.textToBytes(`Restante a Pagar: ${formatCurrency(order.remainingValue)}`),
      cmd.LINE_FEED,
      this.textToBytes(doubleLine),
      cmd.LINE_FEED,
      
      // Observations
      order.observations ? this.combineBytes(
        cmd.BOLD_ON,
        this.textToBytes('OBSERVACOES'),
        cmd.BOLD_OFF,
        cmd.LINE_FEED,
        this.textToBytes(line),
        cmd.LINE_FEED,
        this.textToBytes(order.observations),
        cmd.LINE_FEED,
        cmd.LINE_FEED,
      ) : new Uint8Array(),
...
      this.textToBytes(doubleLine),
      cmd.LINE_FEED,
      this.textToBytes(`Entrada em: ${new Date(order.createdAt).toLocaleString('pt-BR')}`),
      cmd.LINE_FEED,
      order.estimatedDelivery ? this.combineBytes(this.textToBytes('Previsao de Entrega: ' + order.estimatedDelivery), cmd.LINE_FEED) : new Uint8Array(),
      cmd.LINE_FEED,
      this.textToBytes(doubleLine),
      cmd.LINE_FEED,
      cmd.BOLD_ON,
      this.textToBytes('ATENCAO: LEIA OS TERMOS ABAIXO'),
      cmd.BOLD_OFF,
      cmd.LINE_FEED,
      cmd.LINE_FEED,
      cmd.ALIGN_LEFT,
      order.terms ? this.combineBytes(
        ...order.terms.map((term, index) => this.combineBytes(
          this.textToBytes(`${index + 1}. ${term}`),
          cmd.LINE_FEED,
        )),
        cmd.LINE_FEED,
        cmd.LINE_FEED,
...
      // Signature Block
      cmd.ALIGN_CENTER,
      this.textToBytes('________________________________________'),
      cmd.LINE_FEED,
      this.textToBytes(`Tecnico: ${order.attendantName}`),
      cmd.LINE_FEED,
      cmd.LINE_FEED,
      this.textToBytes('________________________________________'),
      cmd.LINE_FEED,
      this.textToBytes(`Cliente: ${order.clientName}`),
      cmd.LINE_FEED,
      cmd.LINE_FEED,
      cmd.LINE_FEED,
      cmd.LINE_FEED,
